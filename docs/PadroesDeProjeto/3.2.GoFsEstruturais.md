...
- `src/apps/provider_mensageria/services/mensageria_facade.py` — **Facade** (`MensageriaFacade`)
- `src/apps/provider_mensageria/services/auth_service.py` — Subsistema 1 (`AuthService`, com `validar_user`)
- `src/apps/provider_llm/services/provider_llm.py` — Subsistema 2 (`ProviderLLM`, loop de *function calling*)
- `src/apps/provider_llm/adapters/openai_adapter.py` — Subsistema 3 (`OpenAIAdapter`, ponte com o GoF Adapter)
- `src/apps/provider_llm/services/tool_executor.py` — Subsistema 4 (`ToolExecutor`, executor das tools)
- `src/apps/provider_mensageria/api/views.py` — Cliente (`WebhookTelegram`)
...
- `src/apps/provider_llm/domain.py` — Produtos do domínio (`LLMResposta`, `ToolCall`)
- `src/apps/provider_llm/ports/llm_port.py` — Target (interface `LLMPort`)
- `src/apps/provider_llm/clients/openai_client.py` — Adaptee (wrapper do SDK `openai`)
- `src/apps/provider_llm/adapters/openai_adapter.py` — Adapter (`OpenAIAdapter`)
- `src/apps/provider_llm/services/provider_llm.py` — Client (`ProviderLLM`)
