...
- `backend/apps/finance/models.py` — Products (`Transacao`, `Entrada`, `Saida`, `Parcelamento`)
- `backend/apps/finance/services/transacao_service.py` — Creator abstrato
- `backend/apps/finance/services/financas_transacao_service.py` — ConcreteCreator
...
- `backend/apps/finance/services/extrato.py` — Product
- `backend/apps/finance/services/extrato_builder.py` — Builder abstrato
- `backend/apps/finance/services/extrato_financeiro_builder.py` — ConcreteBuilder
- `backend/apps/finance/services/extrato_director.py` — Director
